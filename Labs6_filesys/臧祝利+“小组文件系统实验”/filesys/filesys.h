...
extern char* address_name[100];
extern int point_address;
...
extern int getusernumber();
extern void storeusernumber();
extern void adduser(int, char*, int);
extern void modify_pswd(int, char*);
extern void helporder(char*);
#endif
